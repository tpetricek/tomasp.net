...
--------------------------------------------------------------------------------
<h1>WinForms - Vývoj TabletPC aplikací</h1><h2>Co tento článek ukazuje</h2><ul><li>Úvodní informace o vývoji aplikací pro platformu TabletPC</li><li>Popis nejdůležitějších třid z namespace <code>Microsoft.Ink</code></li><li>Ukázka zpracovávající vstup z pera</li></ul><p>Počítače typu TabletPC (s operačním systémem Windows XP TabletPC Edition)
