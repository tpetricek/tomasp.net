...
--------------------------------------------------------------------------------
<h1>ASP.NET - Dynamické vytváření ovládacích prvků</h1><h2>Co tento článek ukazuje</h2><ul><li>Jak lze dynamicky vytvářet ovládací prvky</li><li>Jak přímo přistupovat k datům z HTML formuláře</li><li>Jak je možné ovlivnit ukládání ViewState</li></ul><p>Při tvorbě webových aplikací se můžete dostat do situace, kdy nevíte kolik
