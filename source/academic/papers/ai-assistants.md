...
If you want to cite the paper, you can use the following BibTeX information.
    ...
    [lang=tex]
    @article{petricek-2023-assistants,
      author  = {Tomas Petricek and Gerrit J. J. van den Burg and Alfredo
                 Naz{\'{a}}bal and Taha Ceritli and Ernesto Jim{\'{e}}nez{-}Ruiz
                 and Christopher K. I. Williams},
      title   = {{AI} Assistants: {A} Framework for Semi-Automated Data
                 Wrangling},
