# Technical Dimensions of Programming Systems
 ...
 - description:  We know how to study programming languages, but how to study stateful, interactive and
      graphical programming systems? This paper presents a qualitative framework for thinking and talking about programming systems.
 - tags: academic, publication, top, home
 - layout: article
 - icon: fa fa-map-location-dot
 - date: 15 February 2023
 - title: Technical Dimensions of Programming Systems
 - subtitle: Joel Jakubovic, Jonathan Edwards, Tomas Petricek. The Art, Science, and Engineering of Programming, 2023
...
## Paper and more information
 ...
 - See [the paper record](https://programming-journal.org/2023/7/13/) in The Art, Science, and Engineering of Programming journal.
 - Download [local copy of the final version of the paper (PDF)](paper.pdf)
 - Check out the [extended interactive version of the paper](/techdims)
