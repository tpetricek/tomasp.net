# On the Limits of Making Programming Easy
 ...
 - description: How can we make programming easier? Programming is a tangle of conceptual models,
     languages, user interfaces and more and we cannot advance all of these at the same time.
     This makes it difficult to tackle the problem directly. In this paper, we instead use a
     dialectic method to circumscribe the design space within which easier programming
     systems may exist.
...
## Paper and more information
 ...
 - Download [pre-print of the paper (PDF)](programming-limits.pdf)
 - Get the final [published paper](https://link.springer.com/chapter/10.1007/978-3-032-08187-2_11) from Springer.
 - See [Languages, Compilers, Analysis - From Beautiful Theory to Useful Practice](https://link.springer.com/book/10.1007/978-3-032-08187-2) - Essays Dedicated to Alan Mycroft on the Occasion of His Retirement
